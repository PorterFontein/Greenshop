(() => {
    ...
    (() => {
        ...
        discountSlider.noUiSlider.on("update", (function(values) {
        ...
        da.init();
        var script_button = document.getElementById("show");
        script_button.onclick = show;
        var input = document.getElementById("show1");
        function show() {
            if ("password" == input.getAttribute("type")) {
                input.removeAttribute("type");
                input.setAttribute("type", "text");
                script_button.className = "tabs-header-login__button-hide";
            } else {
                input.removeAttribute("type");
